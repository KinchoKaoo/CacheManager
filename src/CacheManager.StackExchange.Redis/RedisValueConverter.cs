...
namespace CacheManager.Redis
{
        ...
        IRedisValueConverter<object>
    {
        ...
        RedisValue IRedisValueConverter<char>.ToRedisValue(char value) => (int)value;

        char IRedisValueConverter<char>.FromRedisValue(RedisValue value, string valueType) => (char)(int)value;
